...
Ga:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Fermer"},U:[g.XK()]});g.J(this,a);a.Ea(this.Pz.element);this.T(a.element,"click",this.Ci);a=new g.U({G:"button",Ga:["ytp-miniplayer-replay-button","ytp-button"],W:{"aria-label":"Fermer"},U:[g.bL()]});g.J(this,a);a.Ea(this.Pz.element);this.T(a.element,"click",this.mV);this.T(this.player,"presentingplayerstatechange",this.Lc);this.T(this.player,"appresize",this.wb);this.T(this.player,"fullscreentoggled",this.wb);this.wb()};
