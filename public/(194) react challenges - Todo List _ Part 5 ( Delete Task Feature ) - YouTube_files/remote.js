...
L:"ytp-mdx-manual-pairing-popup-dialog",W:{role:"dialog"},U:[{G:"div",L:"ytp-mdx-manual-pairing-popup-dialog-inner-content",U:[{G:"div",L:"ytp-mdx-manual-pairing-popup-title",va:"Nous allons bient\u00f4t supprimer la possibilit\u00e9 de se connecter \u00e0 un t\u00e9l\u00e9viseur via Internet \u00e0 l'aide d'un code"},{G:"div",L:"ytp-mdx-manual-pairing-popup-buttons",U:[{G:"button",Ga:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],va:"En savoir plus"},{G:"button",Ga:["ytp-button","ytp-mdx-manual-pairing-popup-ok"],
va:"OK"}]}]}]});this.i=new g.zL(this,250);this.learnMoreButton=this.Fa("ytp-mdx-manual-pairing-popup-learn-more");this.okButton=this.Fa("ytp-mdx-manual-pairing-popup-ok");g.J(this,this.i);this.T(this.learnMoreButton,"click",this.u);this.T(this.okButton,"click",this.B)},C9=function(){g.U.call(this,{G:"div",
...
{G:"div",L:"ytp-mdx-privacy-popup-buttons",U:[{G:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-cancel"],va:"Annuler"},{G:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-confirm"],va:"Confirmer"}]}]}]});this.i=new g.zL(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.J(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},D9=function(a){g.U.call(this,{G:"div",
...
b=g.T(b,128)?g.qI("Erreur sur $RECEIVER_NAME",c):b.Ac()||g.T(b,4)?g.qI("Lecture sur $RECEIVER_NAME",c):g.qI("Connect\u00e9 \u00e0 $RECEIVER_NAME",c);a.Ra("statustext",b);a.i.show()}else a.i.hide()},E9=function(a,b){g.NP.call(this,"Lire sur",0,a,b);
...
E9.prototype.bj=function(a){return"cast-selector-receiver"===a?"Caster sur\u2026":this.oo[a].name};
